...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-50 via-white to-slate-100 dark:from-slate-950 dark:via-slate-900 dark:to-black p-6 md:p-12">
            ...
            <div className="w-full max-w-2xl animate-in fade-in slide-in-from-bottom-4 duration-700">
              ...
              <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 gap-8 text-left">
                <div className="space-y-2">
                  <h3 className="font-bold text-primary">Why OKLab?</h3>
                ...
                <div className="space-y-2">
                  <h3 className="font-bold text-primary">Smart Gamut Mapping</h3>
                  <p className="text-sm text-muted-foreground">
